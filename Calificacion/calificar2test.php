    ...
    if (!empty($_POST)) {
        ...
        if ($valid) {
            ...
            try {
                ...
                $stmt = $pdo->prepare("CALL premiar_proyectos()");
                $stmt->execute();
...
?>
    ...
    <body>
        ...
        <div class="calificacion">
            <a href='..\proyectos\index.php'><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-back-up-double" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="black" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
