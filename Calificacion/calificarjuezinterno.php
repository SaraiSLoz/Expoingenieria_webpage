...
if (isset($_SESSION["usuario"])) {
    ...
    if (!empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO calificacion(id, calificacion,id_juez,id_proyecto)values(null, ?,?,?)";
            $q = $pdo->prepare($sql);
            ...
            header("Location: index_proyectosjuezinterno.php");
            exit();
        }
    }
...
?>
    ...
    <body>
        ...
        <div class="calificacion">
            <a href='index_proyectosjuezinterno.php'><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-back-up-double" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="black" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <form method="post" action = "calificarjuezinterno.php?id=<?php echo $id ?>" enctype="multipart/form-data">
            <div class="preguntas">
                <table class="todo">
                    <tr class="numeros">
                        <td></td>
                    ...
                    <tr>
                        <td><input type="hidden" name="juez" value="<?php echo $id_juez; ?>"></td>
                    </tr>
                    <tr>
