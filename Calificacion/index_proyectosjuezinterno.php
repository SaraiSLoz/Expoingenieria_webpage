                 ...
                 WHERE id_juez1 = '$usuario' OR id_juez2 = '$usuario'  OR id_juez3 = '$usuario'";
                    ...
                    foreach ($pdo->query($sql) as $row) {
                        ...
                        if ($calificacion !== false) {
                            ...
                            echo '<td class="botoness"><a href="../Calificacion/calificarjuezinterno.php?id=' . $row['id_proy'] . '"><button class="bot-cal1">Calificar</button></a></td>';
                        }
                        echo '<td class = "link2"><a href="readjuecesinternos.php?id=' . $row['id_proy'] . '">Ver más</a></td>';
                        echo '</tr>';
                    }
                    Database::disconnect();
