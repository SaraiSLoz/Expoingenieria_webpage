        ...
        <table class="menu">
            ...
            <table>
                <div class="calificacion">
                    <a href="http://lab403azms01.itesm.mx/TC2005B_403_3/expoingenierias/paginaInicio/index-ProfesorJuez.php"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-back-up-double" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="black" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                 ...
                 WHERE id_juez1 = '$usuario' OR id_juez2 = '$usuario'  OR id_juez3 = '$usuario'";
                    ...
                    foreach ($pdo->query($sql) as $row) {
                        ...
                        if ($calificacion !== false) {
                            ...
                            echo '<td class="botoness"><a href="http://lab403azms01.itesm.mx/TC2005B_403_3/expoingenierias/Calificacion/calificarprofesorjueces.php?id=' . $row['id_proy'] . '"><button class="bot-cal1">Calificar</button></a></td>';
                        }
                        echo '<td class = "link2"><a href="http://lab403azms01.itesm.mx/TC2005B_403_3/expoingenierias/Calificacion/readprofesorjueces.php?id=' . $row['id_proy'] . '">Ver más</a></td>';
                        echo '</tr>';
                    }
                    Database::disconnect();
