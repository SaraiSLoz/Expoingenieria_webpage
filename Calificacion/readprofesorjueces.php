    ...
    <body>
        ...
        <section class="main">
            <div class="calificacion">
                <a href="http://lab403azms01.itesm.mx/TC2005B_403_3/expoingenierias/Calificacion/index_proyectosprofesorjuez.php"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-back-up-double" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="black" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
