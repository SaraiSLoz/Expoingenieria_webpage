...
if (isset($_SESSION["usuario"])) {
  ...
  if ($usuario == null) {
    ...
    $sql = 'SELECT alumnos.matricula, alumnos.nombre,alumnos.email,carrera.nombre as carrera 
        FROM alumnos
...
?>
  ...
  <head>
    <link rel="stylesheet" href="perfil_estudiante1.css">
  </head>
      ...
      <form>
        ...
        <table class="perfil">
          ...
          <tr>
            ...
            <td><input type="text" value=<?php echo $data['carrera']; ?> readonly></td>
            <td></td>
          </tr>
