...
if (isset($_SESSION["usuario"])) {
  ...
  if ($usuario == null) {
    ...
    $sql = 'SELECT jueces.matricula, jueces.nombre,jueces.email,area_estrategica.nombre_a as area
        FROM jueces
        INNER JOIN area_estrategica ON jueces.id_area=area_estrategica.id_a 
        WHERE matricula = ?';
    $q = $pdo->prepare($sql);
