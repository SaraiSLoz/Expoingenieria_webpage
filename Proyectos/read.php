...
if ($id == null) {
    ...
    $sql = 'SELECT proyecto.id_proy, proyecto.titulo, proyecto.status, proyecto.calificacion, proyecto.expoinge, proyecto.descripcion, proyecto.poster, 
        ...
        INNER JOIN profesores ON proyecto.id_profesor = profesores.id
        INNER JOIN unidad_de_formacion ON proyecto.unidad_formacion = unidad_de_formacion.id
        WHERE id_proy = ?';
    $q = $pdo->prepare($sql);
    $q->execute(array($id));
