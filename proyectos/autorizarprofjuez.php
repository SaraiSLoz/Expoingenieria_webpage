...
if (isset($_SESSION["usuario"])) {
    ...
    if ($id == null) {
        header("Location: indexProf-Juez.php");
    } else {
    ...
    <body>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <a href="..\Perfil\perfil_profesorjuez.php">Mi Perfil</a>
                                    <a href="..\Calificacion\index_proyectosprofesorjuez.php">Calificar Proyectos</a>
                                    <a href="..\proyectos\indexProf-Juez.php">Autorizar Proyectos</a>
        ...
        <section class="main">
            <div class="calificacion">
                <a href="indexProf-Juez.php"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-back-up-double" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="black" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <table>
                <tr>
                    <td>
                        <form action="actualizarprofesorjuez.php?id=<?php echo $data['id_proy']; ?>" method="post">
        ...
        <form action="http://lab403azms01.itesm.mx/TC2005B_403_3/expoingenierias/autorizarprofjuez.php?id=<?php echo $data['id_proy']; ?>" method="post" id="formulario" style="display: none;">
            <div>
                <label>Agregar comentario sobre las mejoras del proyecto para poder ser autorizado</label>
                <input type="text" class="textarea" name="comentario" placeholder="Agregar comentario" value="<?php echo !empty($comentario) ? $comentario : ''; ?>">
            </div>
            <div class="modify-btn-container">
