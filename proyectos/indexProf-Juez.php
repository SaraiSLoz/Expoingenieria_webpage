    ...
    <body>
        ...
        <section class="main">
            ...
            <div class="calificacion">
                <a href="../paginaInicio/index-ProfesorJuez.php"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-back-up-double" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="black" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <table>
                ...
                <tbody>
                    ...
                    foreach ($pdo->query($sql) as $row) {
                        ...
                        echo '<td class="botoness"><a href="autorizarprofjuez.php?id=' . $row['id_proy'] . '"><button class="calificar-btn">Autorizar</button></a></td>';
