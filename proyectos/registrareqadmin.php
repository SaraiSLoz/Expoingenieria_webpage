...
?>
    ...
    <body>
        ...
        <form action="http://lab403azms01.itesm.mx/TC2005B_403_3/expoingenierias/proyectos/registrareqadmin.php" method="post">
    ...
    <script>
        $(document).ready(function() {
            $('#myModal').on('hidden.bs.modal', function() {
                window.location.href = 'location:../proyectos/index.php';
            });
        });
    </script>
