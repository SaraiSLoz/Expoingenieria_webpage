...
<body>
	...
	<form class="form-horizontal" action="http://lab403azms01.itesm.mx/TC2005B_403_3/expoingenierias/proyectos/updateadmin.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
		<section>
