...
if (!empty($_POST)) {
  ...
  if ($valid) {
    ...
    $sql = "INSERT INTO jueces (matricula,nombre,contraseña,email,id_area) VALUES (?, ?, ?, ?, ?)";
    $q = $pdo->prepare($sql);
    $q->execute(array($matricula, $nombre, $contraseña, $email, $id_area));
...
<body>
  ...
  <form action="registro_juez.php" method="post" autocomplete="off">
    <section class="main">
      <h1>Registro de usuario</h1>
      <table class="registro">
        <tr>
          <td><input type="text" name="matricula" placeholder="ID..." id="matricula" class="input1" /> </td>
        </tr>
        <tr>
        ...
        <tr>
          <td><select name="id_area" class="input3">
